...
('test', 'test', 'Test (Free Trial)', '测试套餐', 'Pay $0.10 to test payment flow', '支付 0.1 美元测试支付流程', 10, 10, 100, 104857600, 1, '["basic_features"]', 1, strftime('%s', 'now') * 1000, strftime('%s', 'now') * 1000);
